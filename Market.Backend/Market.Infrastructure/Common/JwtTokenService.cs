...
public sealed class JwtTokenService : IJwtTokenService
{
    ...
    public JwtTokenPair IssueTokens(PersonEntity user)
    {
        ...
        var claims = new List<Claim>
        {
            ...
            new("is_manager",  user.IsOrganiser.ToString().ToLowerInvariant()),
            new("is_employee", user.IsUser.ToString().ToLowerInvariant()),
